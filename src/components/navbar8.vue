      ...
      <div data-thq="thq-navbar-nav" class="navbar8-desktop-menu">
        <nav class="navbar8-links1">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            class="navbar8-link4 thq-body-small thq-link"
          >
            <slot name="link31">
              <!--Default content for link31-->
          ...
          <div
            ...
            class="navbar8-link5-dropdown-trigger"
          >
            ...
            <a :href="link1Url" class="navbar8-link12 thq-body-small thq-link">
              <slot name="link1">
                ...
                <div class="navbar8-fragment20">
                  <span class="navbar8-text22">首页</span>
                </div>
              </slot>
            </a>
            <a :href="link2Url" class="thq-body-small thq-link">
              <slot name="link2">
                ...
                <div class="navbar8-fragment10">
                  <span class="navbar8-text12">非遗百科</span>
                </div>
              </slot>
            </a>
            <a :href="link3Url" class="navbar8-link32 thq-body-small thq-link">
              <slot name="link3">
                ...
                <div class="navbar8-fragment23">
                  <span class="navbar8-text25">地图探索</span>
                </div>
              </slot>
            </a>
                ...
                <span class="thq-body-small thq-link">
                  <slot name="link4">
                    ...
                    <div class="navbar8-fragment13">
                      <span class="navbar8-text15">AI探索</span>
                    </div>
                  </slot>
                </span>
                    ...
                    <div class="navbar8-content3">
                      <span class="navbar8-page31 thq-body-large">
                        <slot name="page3">
                          ...
                          <div><span>Cultural Heritage Inheritors</span></div>
                        </slot>
                      </span>
                      <span class="thq-body-small">
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment21">
                    <span class="navbar8-text23">登录</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment22">
                    <span class="navbar8-text24">Secondary Action</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span class="navbar8-page12 thq-body-large">
                  <slot name="page1">
                    ...
                    <div class="navbar8-fragment19">
                      <span class="navbar8-text21">Home</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page1Description">
                    ...
                    <div class="navbar8-fragment14">
                      <span class="navbar8-text16">Page One Description</span>
                    </div>
                  </slot>
                </span>
              </div>
                ...
                <span class="navbar8-page22 thq-body-large">
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment12">
                      <span class="navbar8-text14">Introduction</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment17">
                      <span class="navbar8-text19">Page Two Description</span>
                    </div>
                  </slot>
                </span>
              </div>
            ...
            <div class="navbar8-menu-item7">
              ...
              <div class="navbar8-content7">
                ...
                <span class="thq-body-small">
                  <slot name="page3Description">
                    <!--Default content for page3Description-->
                    <div class="navbar8-fragment24">
                      <span class="navbar8-text26">Page Three Description</span>
                    </div>
                  </slot>
                </span>
              </div>
                ...
                <span class="navbar8-page42 thq-body-large">
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment18">
                      <span class="navbar8-text20">Contact</span>
                    </div>
                  </slot>
                </span>
                <span class="thq-body-small">
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text18">Page Four Description</span>
                    </div>
                  </slot>
                </span>
              </div>
...
export default {
  ...
  props: {
    ...
    page1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1719568867991-80772fe445d2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjY0NjU2OHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    ...
    logoAlt: {
      type: String,
      default: 'Non-material Cultural Heritage of China',
    },
    page4ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1700319006387-e079f8c486d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjY0NjU2OHw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    linkUrlPage4: {
      type: String,
      default: 'https://www.teleporthq.io',
    ...
    page2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1695116794093-5d4ff21e56c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjY0NjU2OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page3ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1740424051372-b8f47c38c2c6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjY0NjU2OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    page2ImageAlt: {
      type: String,
      default: 'image',
