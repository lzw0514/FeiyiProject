          ...
          <h2 class="thq-heading-2">
            <slot name="heading1">
              ...
              <div class="contact10-fragment2">
                <span class="contact10-text17">Locations</span>
              </div>
            </slot>
          </h2>
          ...
          <h3 class="contact10-text12 thq-heading-3">
            <slot name="location1">
              ...
              <div class="contact10-fragment4">
                <span class="contact10-text19">Bucharest</span>
              </div>
            </slot>
          </h3>
          <p class="thq-body-large">
          ...
          <h3 class="contact10-text14 thq-heading-3">
            <slot name="location2">
              ...
              <div class="contact10-fragment3">
                <span class="contact10-text18">Cluj - Napoca</span>
              </div>
            </slot>
          </h3>
          <p class="thq-body-large">
...
export default {
  ...
  props: {
    ...
    location1ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1630309125354-4a3608010502?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjY0NjU2OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
    location2ImageSrc: {
      type: String,
      default:
        'https://images.unsplash.com/photo-1638180541204-72c00c9c8ed0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0MjY0NjU2OXw&ixlib=rb-4.0.3&q=80&w=1080',
    },
  },
}
</script>
